...
#include "kernel_selector.h"
                   ...
                   bool use_fp32_reduce, bool is_zp_float)
    {
        ...
        if (has_act_order)
        {
            ...
            if (moe_block_size == 8)
            {
                ...
                host::RuntimeCheck(false, "unsupported moe_block_size ", moe_block_size);
    ...
    kernel<<<sms, default_threads, 0, stream>>>(
        ...
        {
            host::RuntimeCheck(major_capability * 10 + minor_capability >= 89,
        ...
        host::RuntimeCheck(is_valid_config(thread_tfg, m_block_size_8, thread_m_blocks,
